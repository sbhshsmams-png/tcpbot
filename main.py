...
def create_credentials_template():
    ...
    template = """# Morphxx Free Fire Bot Credentials
# Fill in your Free Fire account credentials below

# Format 1: Comma-separated (RECOMMENDED)
uid=4737686711,password=D8220C732F2EFA6203836C26705E03781CC141EB27F33B1700FC85A314D0E18A

# OR Format 2: Line-separated
# uid: 4737686711
# password: D8220C732F2EFA6203836C26705E03781CC141EB27F33B1700FC85A314D0E18A

# Save this file and restart the bot
"""
    
    filename = "morphxx.txt"
...
def load_credentials_from_file(filename="morphxx.txt"):
    """
...
📱 Player will see:
"MORPHX FF wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]MORPHX FFㅤVIP [FFFF00]___X³____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @Morphxxxx ㅤVIP\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]MORPHX FFㅤ [FFFF00]!!
"""
...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="MORPHX FF", title_id=None):
...
async def send_kyro_title_adapted(chat_id, key, iv, target_uid, nickname="MORPHX FF"):
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="MORPHX FF", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="MORPHX FF", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="MORPHX FF", title_id=title_id)
                    ...
                    try:
                        ...
                        if True:
                            ...
                            try:
                                ...
                                emote_id = 909000063  # 👈 চাইলে change কর
                            ...
                            try:
                                ...
                                bot_uid = 14010319252
                                message_text = f" Can't accept Your request Talk to MORPHX FF"
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by MORPHX FF
/bio Level 70 | Pro Player
/bio Add me: MORPHX FF
...
"""
                                ...
                                credentials = load_credentials_from_file("morphxx.txt")
                                if not credentials:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔═════════════╗
[FFFFFF] ✨ TT= @morphxx__ff   
[FFFFFF]      THANKS FOR USE MY BOT❤️   
[FFFFFF]           AND THANKS FOR YOUR SUPPORT❤️ 
[FF0000]╠═════════════╣
[FFD700] ⚡ OWNER REAL NAME : [FFFFFF]MAHIM
[FFD700]   OWNER ID UID 10173814947
[FFD700]   OWNER GUILD ID 3022031980


[FFD700] ✨ কেউ GUILD BOT [FF0000]কিনতে চাইলে message করবেন, [00FFFF] Telegram: @Morphxxxx
[FF0000]╠═════════════╣
[FFD700] ✨ Developer —͟͞͞ </MORPHX FF
[FFD700]╚═════════════╝"""
...
"""
                        ...
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["mahim", "morphx", "morphxx", "MORPHX", "MORPHX FF", " Morphx ff","Morphxx ff", "Morphx FF", "Mahim", "Mg24", "Maruf", " MG24","Allah", "Nobi", "apUrbo", "apuRbo", "apurBo", " apurbO","apUrBo", "riFAT", "RIfat", "Rifat", "RIFAT", "rifat", ]  # Add your actual name
...
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━"""
                            ...
                            badge_cmnd = """
             [C][B][00BFFF]═════════════════
Danzer Zone ¿ ON FIRE TCP HELP 1
═════════════════
...
❀️ [00BFFF]SPAM WITH BADGE 5"""        
                            ...
                            ad_cmnd = """
              [C][B][FFD700]═════════════════
 Danzer Zone ¿ ON FIRE TCP HELP 2
═════════════════
...
❀️ [FFD700]STOP LAG ATTACK"""
                            ...
                            info_cmnd = """
            [C][B][00FF00]═════════════════
Danzer Zone ¿ ON FIRE TCP HELP 3
═════════════════
...
[B][C][00FF00] ব্যবহার: /e 123456789 ak"""
                            ...
                            about = """
        [C][B][FF00FF]═════════════════
Danzer Zone ¿ ON FIRE TCP HELP 4
═════════════════
...
❀️ [FF00FF]OWNER/CONTACT INFORMATION"""
                            ...
                            adns = """
            [C][B][00FFFF]═════════════════
 Danzer Zone ¿  ON FIRE TCP HELP 5
═════════════════
...
[B][C][FF69B4] গিল্ড এর নিয়ম প্রতি সপ্তাহে ❀️ 2000 গ্লরি দিতে হবে
[FFFF00]════════════════"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from morphxx.txt...")
    credentials = load_credentials_from_file("morphxx.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create morphxx.txt with your UID and password")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 NE-HOST BOT - INITIALIZING")
    print("=" * 50)
